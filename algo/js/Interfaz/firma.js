...
function save(hdd) {
  ...
  if(canvas.toDataURL) {
    ...
    document.getElementById(hdd).value=dataurl;
...
function saveonline(dataurl) {
	...
	req.onreadystatechange = function() { 
        ...
        overlay('Your image has been saved as <input size="50" value="http://exigenc.org/'+response+'"> <a href="#" onclick="overlay_hide()">close</a><br /><img src="http://exigenc.org/'+response+'" />'); 
			}	else {
...
//    if(url.indexOf('://') == -1) { url = 'http://exigenc.org/'+url; }
//    var src = (url.indexOf('http://exigenc.org/') > -1) ? url.replace('http://exigenc.org', '') : 'open.php?u='+url;
