...
<head>
    ...
    <link rel="shortcut icon" href="../../../files/img/weather/clima.png">
...
<body>
    <audio id="audio" controls loop autoplay style="display:none;">
        <source src="../../../files/music/song/wait.mp3" type="audio/mpeg">
    </audio>

    <main>
        <nav>
        <h2><img src="../../../files/img/weather/clima.png" alt="">APP CLIMA</h2>
            <ul>
        ...
        <section>
                ...
                <div class="contenedor">
                    ...
                    <div class="datosprimarios">
                        <div class="grados">
                            <h2 id="grados"></h2>
                            <img src="../../../files/img/weather/grados.png" width="70" height="70" alt="">
                            <div id="temperatura">
                            </div>
                        </div>
                        <div id="estado">
                            <img src="../../../files/img/weather/mundo.png" width="70%" alt="">
                        </div>
                    </div>
                </div>
        </section>
...
<!-- ------------------ -->
    <section>
        <div class="examples">
            <img src="../../../files/img/weather/clima.png" width="100" alt="">
            <img src="../../../files/img/weather/mundo.png" width="100" alt="">
            <img src="../../../files/img/weather/nublado.png" width="100" alt="">
            <img src="../../../files/img/weather/lluvia.png" width="100" alt="">
            <img src="../../../files/img/weather/aguanieve.png" width="100" alt="">
            <img src="../../../files/img/weather/snow.png" width="100" alt="">
            <img src="../../../files/img/weather/nieve.png" width="100" alt="">
            <img src="../../../files/img/weather/trueno.png" width="100" alt="">
            <img src="../../../files/img/weather/noche.png" width="100" alt="">
            <img src="../../../files/img/weather/nube.png" width="100" alt="">
            <img src="../../../files/img/weather/nubes.png" width="100" alt="">
            <img src="../../../files/img/weather/hot.png" width="100" alt="">
            <img src="../../../files/img/weather/cold.png" width="100" alt="">
            <img src="../../../files/img/weather/centigrado.png" width="100" alt="">
            <img src="../../../files/img/weather/termometro.png" width="100" alt="">
            <img src="../../../files/img/weather/sol.png" width="100" alt="">
        </div>
    </section>
...
function buscarImagen() {
    ...
    xhttp.onreadystatechange = function() {
        if (this.readyState == 4 && this.status == 200) {
            ...
            if(grade > 17){
                temperatura.innerHTML = "<img src='../../../files/img/weather/hot.png' width='50' alt=''>";
            }else{
                temperatura.innerHTML = "<img src='../../../files/img/weather/cold.png' width='50' alt=''>";
            };
