...
let proyect1 = document.querySelector("#proyect1").addEventListener("mousemove", function(){
    preview.innerHTML = `<img src="../img/examples/search_image.PNG" alt="">`;
});
let proyect2 = document.querySelector("#proyect2").addEventListener("mousemove", function(){
    preview.innerHTML = `<img src="../img/examples/properties.PNG" alt="">`;
});
let proyect2_1 = document.querySelector("#proyect2_1").addEventListener("mousemove", function(){
    preview.innerHTML = `<img src="../img/examples/proyecto2_1.jpg" alt="">`;
});
...
let proyect7 = document.querySelector("#proyect7").addEventListener("mousemove", function(){
    preview.innerHTML = `<img src="../img/examples/burger.PNG" alt="">`;
});
